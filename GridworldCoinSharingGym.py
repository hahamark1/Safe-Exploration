...
class GridworldCoinSharingGym(gym.Env):
    ...
    def __init__(self, headless=True, gridworld_size=11, max_steps=20000, kill_reward=0, step_reward=1, dead_reward=0, window_size=5):
    ...
    def get_observation(self):
        ...
        window = [range(self.agent_position[0] - int(self.window_size/2), self.agent_position[0] + int(self.window_size/2) + 1), range(self.agent_position[1] - int(self.window_size/2), self.agent_position[1] + int(self.window_size/2) + 1)]
        ...
        agent_observation[int(self.window_size/2), int(self.window_size/2)] = 5*(self.coins_collected + 1)
        ...
        if closest_enemy:
            ...
            enemy_observation[int(self.window_size/2),int(self.window_size/2)] = 5*(self.enemy_coins_collected + 1)
    ...
    def step(self, action_num):
        ...
        reward = coin_collected / (self.coins_collected + 0.0000001)
        info = {'got_killed': dead, 'num_killed': 0, 'coins_collected': coin_collected, 'enemy_coins_collected': enemey_coin_collected}
