...
experiment_dir = os.path.abspath(f"logs/coinsharing/version_11.1/maxsteps_{max_steps}/step_reward_{step_reward}/dead_reward_{dead_reward}/kill_reward_{kill_reward}/selfishness_{selfishness}/seed_{seed}")
