...
class GridworldTest(gym.Env):
    ...
    def get_observation(self):
        ...
        if closest_enemy:
            ...
            enemy_observation = agent_observation
    ...
    def step(self, action_num):
        ...
        #reward = (2*coin_collected) / 2**self.coins_collected
        reward = coin_collected * (1.1 - self.coins_collected * 0.1)
        info = {'got_killed': dead, 'num_killed': 0, 'coins_collected': coin_collected, 'enemy_coins_collected': enemey_coin_collected, 'enemy_reward': 0 }
...
if __name__ == "__main__":
    env = GridworldTest(headless=False, gridworld_size=7)
